...
<h2>Data Barang Masuk</h2>
    <form action="index.php?page=barang_masuk" method="get" class="input-group float-end mb-3" style="width: 200px;">
    ...
    <table class="table table-bordered table-success table-striped table-hover">
        ...
        <?php 
            ...
            $query = "SELECT stoktransaksi.id_transaksi, produk.kode_produk, produk.nama_produk, stoktransaksi.no_invoice, 
                      ...
                      FROM stoktransaksi
                      INNER JOIN produk ON stoktransaksi.produk_id = produk.id_produk
