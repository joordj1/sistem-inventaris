...
try {
    ...
    save_histori_log_entry($koneksi, [
        ...
        'target_user_name_snapshot' => get_user_name_by_id($koneksi, $id_user),
        'deskripsi' => 'Assign cepat unit asset. Untuk BA formal gunakan modul serah terima barang.',
        'meta_json' => [
            'lokasi' => $previousLocation,
            'note' => $note,
        ],
